...
latex_documents = [('index', 'Overviewer.tex', u'Overviewer Documentation', u'The Overviewer Team', 'manual'), ]
...
man_pages = [('index', 'overviewer', u'Overviewer Documentation', [u'The Overviewer Team'], 1)]
